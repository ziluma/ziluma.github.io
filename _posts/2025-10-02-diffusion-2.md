...
Tune $\sigma_t\ge 0$ and solve 

$$
X_1\sim \mathcal{N}(0,I),\quad 
d X_t = \left[V_t^\theta(X_t)+\tfrac{1}{2}\sigma_t^2 s_t^\theta(X_t)\right]\,dt + \sigma_t^2 \,dW_t.
$$

Any instance of $X_0$ is a generation.
